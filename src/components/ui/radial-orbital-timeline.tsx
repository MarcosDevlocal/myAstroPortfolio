...
export default function RadialOrbitalTimeline({ timelineData, className }: RadialOrbitalTimelineProps) {
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "flex w-full flex-col items-center justify-center overflow-x-hidden bg-black py-10",
        "min-h-[min(92svh,900px)] max-h-[960px]",
        className
      )}
              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    isExpanded ? "scale-150 border-white bg-white text-black shadow-lg shadow-white/30" : "",
                    !isExpanded && isRelated && "animate-pulse border-white bg-white/50 text-black",
                    !isExpanded && !isRelated && "border-white/40 bg-black text-white"
                  )}
                >
                  <Icon size={16} />
                </div>
                ...
                {isExpanded && (
                  <Card className="absolute left-1/2 top-20 z-[220] w-64 -translate-x-1/2 overflow-visible border-white/30 bg-black/90 shadow-xl shadow-white/10 backdrop-blur-lg">
                            ...
                            {item.relatedIds.map((relatedId) => {
                              ...
                              return (
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className="flex h-6 items-center rounded-none border-white/20 bg-transparent px-2 py-0 text-xs text-white/80 hover:bg-white/10 hover:text-white"
                                  onClick={(e) => {
                                    e.stopPropagation();
