...
import { useEffect, useRef, useCallback, type CSSProperties, type PointerEvent } from "react";
          ...
          style={
            {
              ...
              ...({ positionAnchor: `--cobe-${m.id}` } as Record<string, unknown>),
            } as CSSProperties
          }
        >
          {m.label}
            ...
            style={
              {
                ...
                transition: "opacity 0.8s, filter 0.8s",
                ...({ positionAnchor: `--cobe-arc-${a.id}` } as Record<string, unknown>),
              } as CSSProperties
            }
          >
            {a.label}
